...
template <> struct DTypeMap<DTYPE_CODE_FLOAT32> {
  using type = float;
};
template <> struct DTypeMap<DTYPE_CODE_FLOAT16> {
  using type = half;
};
template <> struct DTypeMap<DTYPE_CODE_BFLOAT16> {
...
template <> struct FP8DTypeMap<DTYPE_CODE_FLOAT8_E4M3FN> {
  using type = __hip_fp8_e4m3_fnuz;
};
template <> struct FP8DTypeMap<DTYPE_CODE_FLOAT8_E5M2> {
...
// Usage: DISPATCH_FP8_OUTPUT_DTYPE(dtype_code, OutputType, { /* code using
// OutputType */ });
...
// Usage: DISPATCH_INPUT_FP8_OUTPUT_DTYPES(in_code, out_code, InputType,
// OutputType,
//                                          { /* code using InputType and
//                                          OutputType */ });
...
// Usage: DISPATCH_FP8_INPUT_HALF_OUTPUT_DTYPES(in_code, out_code, InputType,
// OutputType,
//                                               { /* code using InputType and
//                                               OutputType */ });
#define DISPATCH_FP8_INPUT_HALF_OUTPUT_DTYPES(                                 \
    in_dtype_code, out_dtype_code, in_type_name, out_type_name, ...)           \
...
// Usage: DISPATCH_FP8_INPUT_FP_OUTPUT_DTYPES(in_code, out_code, InputType,
// OutputType,
//                                            { /* code using InputType and
//                                            OutputType */ });
...
// Macro for nested dispatch on FP16/BF16 input and FP32/FP16/BF16 freqs/output
// dtypes Usage: DISPATCH_HALF_INPUT_FP_FREQS_DTYPES(in_code, freqs_code,
// InputType, FreqsType,
//                                             { /* code using InputType and
//                                             FreqsType */ });
#define DISPATCH_HALF_INPUT_FP_FREQS_DTYPES(                                   \
    in_dtype_code, freqs_dtype_code, in_type_name, freqs_type_name, ...)       \
