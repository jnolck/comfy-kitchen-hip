...
public:
  ...
  using cublasLtMatmul_t = cublasStatus_t (*)(
      ...
      cudaStream_t);
  using cublasLtMatmulDescCreate_t = cublasStatus_t (*)(cublasLtMatmulDesc_t *,
                                                        cublasComputeType_t,
                                                        cudaDataType_t);
  using cublasLtMatmulDescDestroy_t = cublasStatus_t (*)(cublasLtMatmulDesc_t);
  using cublasLtMatmulDescSetAttribute_t =
      cublasStatus_t (*)(cublasLtMatmulDesc_t, cublasLtMatmulDescAttributes_t,
                         const void *, size_t);
  using cublasLtMatrixLayoutCreate_t = cublasStatus_t (*)(
      cublasLtMatrixLayout_t *, cudaDataType_t, uint64_t, uint64_t, int64_t);
  using cublasLtMatrixLayoutDestroy_t =
      cublasStatus_t (*)(cublasLtMatrixLayout_t);
  using cublasLtMatmulPreferenceCreate_t =
      cublasStatus_t (*)(cublasLtMatmulPreference_t *);
  using cublasLtMatmulPreferenceDestroy_t =
      cublasStatus_t (*)(cublasLtMatmulPreference_t);
...
private:
  CublasLtRuntime() { load(); }

  ~CublasLtRuntime() { unload(); }
  ...
  void load() {
    ...
    //     const char *lib_names[] = {"cublasLt64_13.dll",
    //                                "cublasLt64.dll", // Fallback (may
    //                                be 13.x) nullptr};
    //
    ...
    const char *lib_names[] = {"libcublasLt.so.13",
    ...
    if (!handle_) {
      error_message_ =
          std::string("cuBLASLt 13.x library not found (requires CUDA 13+): ") +
          dlerror();
      return;
    }
    // #endif
